...
image::{oss-images}/spring-boot-AnnotationConfigEmbeddedWebApplicationContext.png[]

image::{oss-images}/spring-boot-AnnotationConfigApplicationContext.png[]
...
image::{oss-images}/spring-boot-beanfactory1.png[]

image::{oss-images}/spring-boot-beanfactory2.png[]

image::{oss-images}/spring-boot-beanfactory3.png[]

image::{oss-images}/spring-boot-beanfactory4.png[]
